...
from comparison.source.ronin.model_temporal import TCNSeqNetwork


class RoninTCNReconstructor:
    ...
    def __init__(
        ...
        """
        Reconstruction model based on Ronin TCN.
        ...
        self.tcn_net.load_state_dict(torch.load("./comparison/models_data/ronin_tcn_state_dict.pt"))
        self.tcn_net.eval().cuda()
