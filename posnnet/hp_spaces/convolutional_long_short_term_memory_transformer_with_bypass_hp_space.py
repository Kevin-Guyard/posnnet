...
class ConvolutionalLongShortTermMemoryTransformerWithBypassHpSpace:
    ...
    def __init__(
        ...
        """
        Initiate the hyperparameters space for the CLSTMTWB model.
        For a more complete hyperparameters descriptions, check the class docstring in posnnet.models.convolutional_long_short_term_memory_transformer_with_bypass.
