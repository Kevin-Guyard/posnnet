...
class SpatioTemporalTransformerFrequencyAwareWithBypassHpSpace:
    ...
    def __init__(
        ...
        """
        Initiate the hyperparameters space for the STTFAWB model.
        For a more complete hyperparameters descriptions, check the class docstring in posnnet.models.spatio_temporal_transformer_frequency_aware_with_bypass.
